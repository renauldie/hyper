            ...
            <col-md-12 class="col-lg-12">
              <table class="table table-borderless">
                <tr>
                  ...
                  <td class="pr-5 mt-1" style="text-align: right">{{ $items->user->name }}</td>
                </tr>
                <tr>
                  <th class="pl-5">Blood Pressure</th>
                  <td class="pr-5 mt-1" style="text-align: right">{{ $items->blood_pressure }} MmHg</td>
                </tr>
                <tr>
                  <th class="pl-5">Age</th>
                  <td class="pr-5 mt-1" style="text-align: right">{{ $items->ages }} Y.O</td>
                </tr>
                <tr>
                  <th class="pl-5">Body Weight</th>
                  <td class="pr-5 mt-1" style="text-align: right">{{ $items->body_weight }} Kg</td>
                </tr>
              </table>
            </col-md-12>
          </div>
