    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ route('age.create')}}" class="btn btn-primary mr-4 float-right">
            Add age
          </a>
            ...
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $main -> start_age }} - {{ $main->end_age }}</td>
                  <td style="width: 150px">
                    <a href="{{ route('age.edit', $main->id) }}" class="btn btn-info btn-sm">
                      <i class="icon-note menu-icon"></i>
                    </a>
                    <form action="{{ route('age.destroy', $main->id) }}" method="POST" class="d-inline">
                      @csrf
                      @method('delete')
